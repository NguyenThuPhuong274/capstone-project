  ...
  return (
    <section id="blog" className="bg-primary/5 py-16 md:py-20 lg:py-28 h-full">
      <div className="container">
        ...
        />
      <div>
    <div id="carousel" className="relative h-[760px] w-full pl-20 pr-20 pb-20" data-carousel="slide" data-carousel-interval="5000">
   ...
   {pageList.map((pageNumber) => {
    ...
    return  <div key={pageNumber} data-carousel-item className= "w-full h-full hidden duration-700 ease-in-out grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 md:gap-x-6 lg:gap-x-8 xl:grid-cols-3">
